...
typedef struct _RmaMultiInputTable {
    ...
    UB  * I981;
    UB  * I982;
    struct _RmaMultiInputTable * I955;
    struct _RmaMultiInputTable * I984;
} RmaMultiInputTable;
...
typedef struct {
    U  I648;
    U  I656;
    RmaThreadSchedCompiledLoads  * I1108;
...
typedef struct {
    ...
    US  I1171;
    RP  I1172;
    RemoteDbsedLoad   I1173[1];
} RmaRtlEdgeBlock;
typedef struct TableAssign_ {
    struct TableAssign_ * I955;
...
typedef struct TableAssignLayoutOnClk_ {
    struct TableAssignLayoutOnClk_ * I955;
...
typedef struct TableAssignLayoutOnClkOpt_ {
    struct TableAssignLayoutOnClkOpt_ * I955;
    ...
    U  I1188 :1;
    U  I979 :9;
    RmaSeqPrimOutputOnClkOpt  I1190;
    RmaSeqPrimOutputEblkData  I1194;
...
struct dummyq_struct {
    ...
    struct futq * I1301;
    struct futq * I1302;
    struct sched_table * I1303;
    struct futq_info * I1305;
    ...
    EBLK  * I1364;
    int I1365;
    struct vcs_globals_t * I1366;
    U  I1368;
    clock_struct  I1369;
    unsigned long long I1370;
    EBLK  * I1371;
    EBLK  * I1372;
    void * I1373;
