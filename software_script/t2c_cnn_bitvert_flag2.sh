...
save_path="/home/jm2787/BitSim/save/${model}/ptq/lsq_minmax_channel/${model}_w8_a8_lr1e-3_batch128_cross_entropyloss/structured_columnprune${flag}/grp${grp_size}/column${N}/Structured_All_pr${pr}_512_N5M4/"
