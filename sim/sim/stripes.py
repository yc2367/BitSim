...
class Stripes(Accelerator):
    ...
    PE_ENERGY = 0.3225 # energy per PE
    W_REG_ENERGY_PER_ROW = 0.275 # energy (pJ) of the weight shift register file for a PE row
    I_REG_ENERGY_PER_COL = 0.325 # energy (pJ) of the activation register file for a PE column
    PE_AREA = 1
    ...
    def __init__(self, 
        ...
        self.total_sram_energy = 0
        self.total_dram_energy = 0
